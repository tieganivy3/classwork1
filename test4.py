mylist=[]
# we are define that we need a list for student names
mylist1=[]
# we are define that we need a list for results for fractions
mylist2=[]
# we are define that we need a list for results for algebra
mylist3=[]    
# we are define that we need a list for results for trigonometry
...
# we set username and password if wrong user is asked to re-enter
while True:
    try:
...
for i in range(r):
    ...
    while True:
        ...
        #if the the result of fractions is correct.
        #we're ready to exit the loop.
              break
    mylist1.append(r1)
    while True:
        ...
        #if the the result of algebra is correct.
        #we're ready to exit the loop.
              break
    mylist2.append(r2)
    while True:
        ...
        #if the the result of trigonometry is correct.
        #we're ready to exit the loop.
              break
    mylist3.append(r3)
def Average(mylist1):
...
# we find averange of all results and print
print(mylist)
print(mylist1)
print(mylist2)
print(mylist3)
# we also print all of our lists
print("Good bye")
# we end program by saying goodbye
